  ...
  return (
    <div ref={containerRef} className="relative w-full overflow-hidden">
      <div ref={trackRef} className="flex items-center gap-12 will-change-transform">
        {logos.map((logo) => (
          <div key={logo.id} className="logo-item flex-shrink-0 w-40 h-20 flex items-center justify-center opacity-60 hover:opacity-100 transition-opacity duration-300">
